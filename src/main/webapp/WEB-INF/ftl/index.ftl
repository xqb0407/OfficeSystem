...
<head>
   ...
   <script type="text/javascript" src="/resource/js/okconfig.js"></script>
...
<div class="layui-layout layui-layout-admin okadmin blue_theme">
   ...
   <div class="layui-header okadmin-header">
      ...
      <ul class="layui-nav layui-layout-right">
         ...
         <!-- <li class="layui-nav-item">
             <span class="now-time" style="color: #000000;padding-left: 10px;">2020-10-10 15:12:30</span>
         </li> -->
         ...
         <li class="no-line layui-nav-item">
            ...
            <dl id="userInfo" class="layui-nav-child">
               <dd><a lay-id="u-1" href="javascript:" data-url="/resource/pages/member/user.html">个人中心<span
                             class="layui-badge-dot"></span></a></dd>
               <dd><a lay-id="u-2" href="javascript:" data-url="/resource/pages/member/user-info.html">基本资料</a></dd>
               <dd><a lay-id="u-3" href="javascript:" data-url="/resource/pages/member/user-pwd.html">安全设置</a></dd>
   ...
   <div class="layui-side layui-side-menu okadmin-bg-20222A ok-left">
      <div class="layui-side-scroll okadmin-side">
         <div class="okadmin-logo">OA办公系统</div>
         <div class="user-photo">
            <a class="img" title="我的头像">
               <img src="/resource/images/avatar.png" class="userAvatar">
            </a>
            <p>你好！<span class="userName">${current_User.getName()}—${current_User.getTitle()}</span>, 欢迎登录</p>
         </div>
         <!--左侧导航菜单-->
         <ul id="navBar" class="layui-nav okadmin-nav okadmin-bg-20222A layui-nav-tree">
            <li class="layui-nav-item layui-this">
               <a href="javascript:" lay-id="1" data-url="/console.ftl">
      ...
      <div class="layui-tab ok-tab" lay-filter="ok-tab" lay-allowClose="true" lay-unauto>
         ...
         <div id="tabContent" class="layui-tab-content ok-tab-content">
            <div class="layui-tab-item layui-show">
               <iframe id="ifram" src="/pageServlet?page=Console"  frameborder="0" scrolling="yes" width="100%"
                       height="100%"></iframe>
            </div>
         </div>
      </div>
...
<div class="lock-screen">
   <div class="lock-bg">
      <img class="active lock-gradual" src="/resource/images/wallpaper/9f28afe0e71b3ba8778e307bea2f006K.jpg" alt="" />
      <img class="lock-gradual" src="/resource/images/wallpaper/9f28afe0e71b3ba8778e307bea2f006d.jpg" alt="" />
      <img class="lock-gradual" src="/resource/images/wallpaper/29bce2d5cf30fc96866dcb5e287661ea.jpg" alt="" />
      <img class="lock-gradual" src="/resource/images/wallpaper/b4b55f8ec6b2763a737a2d6e1c50b71e.jpg" alt="" />
      <img class="lock-gradual" src="/resource/images/wallpaper/b8df65c6452dcf8b0302b8bfce9e7ec9.jpg" alt="" />
      <img class="lock-gradual" src="/resource/images/wallpaper/b390e4c33b7d656f09dc7fd155759a4f.jpg" alt="" />
      <img class="lock-gradual" src="/resource/images/wallpaper/3fded2e777723f145a4773dfdb68a9e3.jpg" alt="" />
   </div>
         ...
         <tr>
            <td>
               <div class="layui-form lock-form">
                  <div class="lock-head">
                     <img src="/resource/images/avatar.png" alt="avatar.png" />
                  </div>
...
<script src="/resource/js/snowflake.js?snowflake=雪花"></script>
